...
void writeEnvFile ();
void readEnvFile();
void updateEnvVariable(const String &key, const String &valur);
bool configureNetwork(String IPAddressStr , String gatwayStr , String subnetStr , String dnsa);
IPAddress stringToIPAddress (String ip5tr);
